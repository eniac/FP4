...
@name(".flow_counter_1") Register<bit<32>, bit<32>>(32w1024) flow_counter_1;

@name(".flow_counter_2") Register<bit<32>, bit<32>>(32w1024) flow_counter_2;

@name(".flow_counter_warning_1") Register<bit<32>, bit<32>>(32w1024) flow_counter_warning_1;

@name(".flow_counter_warning_2") Register<bit<32>, bit<32>>(32w1024) flow_counter_warning_2;
...
control ingress(inout headers hdr, inout metadata meta, in ingress_intrinsic_metadata_t ig_intr_md, in ingress_intrinsic_metadata_from_parser_t ig_intr_md_from_parser_aux, inout ingress_intrinsic_metadata_for_deparser_t ig_intr_md_for_dprsr, inout ingress_intrinsic_metadata_for_tm_t ig_intr_md_for_tm) {
    ...
    @name(".riw_flow_counter_1") RegisterAction<bit<32>, bit<32>, bit<32>>(flow_counter_1) riw_flow_counter_1 = {
    ...
    @name(".riw_flow_counter_2") RegisterAction<bit<32>, bit<32>, bit<32>>(flow_counter_2) riw_flow_counter_2 = {
        void apply(inout bit<32> value, out bit<32> rv) {
            rv = 32w0;
            bit<32> in_value;
            in_value = value;
    ...
    @name(".riw_flow_counter_warning_1") RegisterAction<bit<32>, bit<32>, bit<32>>(flow_counter_warning_1) riw_flow_counter_warning_1 = {
        void apply(inout bit<32> value, out bit<32> rv) {
            rv = 32w0;
            bit<32> in_value;
            in_value = value;
            rv = in_value;
            if (meta.meta.reg_val_one > 32w64) {
                value = 32w1;
            }
        }
    };
    @name(".riw_flow_counter_warning_2") RegisterAction<bit<32>, bit<32>, bit<32>>(flow_counter_warning_2) riw_flow_counter_warning_2 = {
        void apply(inout bit<32> value, out bit<32> rv) {
            rv = 32w0;
            bit<32> in_value;
            in_value = value;
            rv = in_value;
            if (meta.meta.reg_val_two > 32w64) {
                value = 32w1;
            }
        }
    };
    ...
    @name(".ai_handle_blacklist") action ai_handle_blacklist() {
        ig_intr_md_for_dprsr.drop_ctl = 3w1;
    }
    @name(".aiSendDigest") action aiSendDigest() {
        {
    ...
    @name(".ai_write_flow_counter_1") action ai_write_flow_counter_1() {
        meta.meta.reg_val_one = riw_flow_counter_1.execute((bit<32>)meta.meta.reg_pos_one);
    }
    @name(".ai_write_flow_counter_2") action ai_write_flow_counter_2() {
        meta.meta.reg_val_two = riw_flow_counter_2.execute((bit<32>)meta.meta.reg_pos_two);
    }
    @name(".ai_write_flow_counter_warning_1") action ai_write_flow_counter_warning_1() {
        meta.meta.reg_val_one_warning = (bit<8>)riw_flow_counter_warning_1.execute((bit<32>)meta.meta.reg_pos_one);
    }
    @name(".ai_write_flow_counter_warning_2") action ai_write_flow_counter_warning_2() {
        meta.meta.reg_val_two_warning = (bit<8>)riw_flow_counter_warning_2.execute((bit<32>)meta.meta.reg_pos_two);
    }
    ...
    @name(".tiSendDigest_1") table tiSendDigest_1 {
        actions = {
            aiSendDigest();
        }
        const default_action = aiSendDigest();
    }
    @name(".tiSendDigest_2") table tiSendDigest_2 {
        actions = {
            aiSendDigest();
        }
        const default_action = aiSendDigest();
    }
    @name(".ti_calculate_hash") table ti_calculate_hash {
        actions = {
            ai_calculate_hash();
        }
        size = 1;
    ...
    @name(".ti_write_flow_counter_1") table ti_write_flow_counter_1 {
        actions = {
    ...
    @name(".ti_write_flow_counter_2") table ti_write_flow_counter_2 {
        actions = {
    ...
    @name(".ti_write_flow_counter_warning_1") table ti_write_flow_counter_warning_1 {
        actions = {
    ...
    @name(".ti_write_flow_counter_warning_2") table ti_write_flow_counter_warning_2 {
        actions = {
    ...
    apply {
        if (hdr.ipv4.isValid()) {
            ...
            if (meta.meta.reg_val_one_warning == 8w1) {
                tiSendDigest_1.apply();
            }
            if (meta.meta.reg_val_two_warning == 8w1) {
