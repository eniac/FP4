...
// don't parse entire header, if not required
    ...
    set_metadata(l3_metadata.rocev2_dst_qp, current(40, 24));
    set_metadata(l3_metadata.rocev2_ack_req_rsvd,   current(64, 8)); // Acknowledge request (A) bit + 7-bits of reserved after that
