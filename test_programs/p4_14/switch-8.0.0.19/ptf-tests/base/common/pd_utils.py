...
def populate_default_fabric_entries(client,
    ...
    #client.egress_internal_header_rewrite_set_default_action_strip_internal_header(#    sess_hdl, dev_tgt)
...
#        action_spec = dc_set_egress_if_params_double_tagged_action_spec_t(
#            action_s_tag=stag, action_c_tag=ctag, action_egress_if_label=0)
#        hdl = \
#            client.egress_vlan_xlate_table_add_with_set_egress_if_params_double_tagged(sess_hdl, dev_tgt, match_spec, action_spec)
    return hdl
