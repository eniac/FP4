...
action ai_mvbl_1_VIRTUAL_START_arpisValidarpoper2() {
  add_to_field(pfuzz_visited.encoding_i1, 1);
}

table ti_mvbl_1_VIRTUAL_START_arpisValidarpoper2{
  actions {
    ai_mvbl_1_VIRTUAL_START_arpisValidarpoper2;
  }
  default_action: ai_mvbl_1_VIRTUAL_START_arpisValidarpoper2();
}

action ai_mvbl_4_VIRTUAL_START_ipv4isValid() {
  add_to_field(pfuzz_visited.encoding_i4, 1);
}

table ti_mvbl_4_VIRTUAL_START_ipv4isValid{
  actions {
    ai_mvbl_4_VIRTUAL_START_ipv4isValid;
  }
  default_action: ai_mvbl_4_VIRTUAL_START_ipv4isValid();
}

action ai_mvbl_5_VIRTUAL_START_arpisValidarpoper1() {
  add_to_field(pfuzz_visited.encoding_i5, 1);
}

table ti_mvbl_5_VIRTUAL_START_arpisValidarpoper1{
  actions {
    ai_mvbl_5_VIRTUAL_START_arpisValidarpoper1;
  }
  default_action: ai_mvbl_5_VIRTUAL_START_arpisValidarpoper1();
}

action ai_mvbl_8_VIRTUAL_START_distance_vecisValid() {
  add_to_field(pfuzz_visited.encoding_i8, 1);
}

table ti_mvbl_8_VIRTUAL_START_distance_vecisValid{
  actions {
    ai_mvbl_8_VIRTUAL_START_distance_vecisValid;
  }
  default_action: ai_mvbl_8_VIRTUAL_START_distance_vecisValid();
}
