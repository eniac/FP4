...
field_list fi_bf_hash_fields_16 {
  fp4_visited.acquire_lock_action;
  fp4_visited.decode_action;
  fp4_visited.drop_action;
  fp4_visited.release_lock_action;
  fp4_visited.reply_to_client_action;
  fp4_visited.set_egress;
  fp4_visited.set_retry_action;
}
...
action ai_recycle_packet() {
  ...
  modify_field(fp4_visited.acquire_lock_action, 0);
  modify_field(fp4_visited.decode_action, 0);
  modify_field(fp4_visited.drop_action, 0);
  modify_field(fp4_visited.release_lock_action, 0);
  modify_field(fp4_visited.reply_to_client_action, 0);
  modify_field(fp4_visited.set_egress, 0);
  modify_field(fp4_visited.set_retry_action, 0);
}
...
action ae_move_IF_CONDITION_2_parser_4(){
  modify_field(fp4_metadata.max_bits_field0, nc_hdr.lock);
}
action ae_move_IF_CONDITION_3_parser_4(){
  modify_field(fp4_metadata.max_bits_field0, nc_hdr.op);
}
action ae_move_ipv4_route_parser_4(){
  modify_field(fp4_metadata.max_bits_field0, ipv4.dstAddr);
  modify_field(fp4_metadata.max_bits_field1, ipv4.srcAddr);
}
...
action ae_apply_mutations1() {
  modify_field_rng_uniform(fp4_metadata.max_bits_field1, 0,0xffffffff);
}
...
action ae_move_back_IF_CONDITION_2_parser_4(){
  modify_field(nc_hdr.lock, fp4_metadata.max_bits_field0);
  modify_field(nc_hdr_clone.lock, fp4_metadata.max_bits_field0);
}
action ae_move_back_IF_CONDITION_3_parser_4(){
  modify_field(nc_hdr.op, fp4_metadata.max_bits_field0);
  modify_field(nc_hdr_clone.op, fp4_metadata.max_bits_field0);
}
action ae_move_back_ipv4_route_parser_4(){
  ...
  modify_field(ipv4.srcAddr, fp4_metadata.max_bits_field1);
  modify_field(ipv4_clone.srcAddr, fp4_metadata.max_bits_field1);
}
