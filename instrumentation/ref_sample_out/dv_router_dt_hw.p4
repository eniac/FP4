...
field_list fi_bf_hash_fields_16 {
  fp4_visited.aDrop_fp4_tiDrop;
  fp4_visited.aDrop_fp4_tiHandleIncomingArpReqest_part_two;
  fp4_visited.aDrop_fp4_tiHandleIncomingEthernet;
  fp4_visited.aDrop_fp4_tiHandleIpv4;
  fp4_visited.aiArpMiss;
  fp4_visited.aiFindNextL3Hop;
  fp4_visited.aiForMe;
  fp4_visited.aiForward;
  fp4_visited.aiHandleIncomingArpReqest_part_one;
  fp4_visited.aiHandleIncomingArpReqest_part_two;
  fp4_visited.aiHandleIncomingArpResponse;
  fp4_visited.aiHandleIncomingRouting;
  fp4_visited.aiHandleOutgoingRouting;
  fp4_visited.aiSendToLastHop;
}
...
action ai_recycle_packet() {
  ...
  modify_field(fp4_visited.aDrop_fp4_tiDrop, 0);
  modify_field(fp4_visited.aDrop_fp4_tiHandleIncomingArpReqest_part_two, 0);
  modify_field(fp4_visited.aDrop_fp4_tiHandleIncomingEthernet, 0);
  modify_field(fp4_visited.aDrop_fp4_tiHandleIpv4, 0);
  modify_field(fp4_visited.aiArpMiss, 0);
  modify_field(fp4_visited.aiFindNextL3Hop, 0);
  modify_field(fp4_visited.aiForMe, 0);
  modify_field(fp4_visited.aiForward, 0);
  modify_field(fp4_visited.aiHandleIncomingArpReqest_part_one, 0);
  modify_field(fp4_visited.aiHandleIncomingArpReqest_part_two, 0);
  modify_field(fp4_visited.aiHandleIncomingArpResponse, 0);
  modify_field(fp4_visited.aiHandleIncomingRouting, 0);
  modify_field(fp4_visited.aiHandleOutgoingRouting, 0);
  modify_field(fp4_visited.aiSendToLastHop, 0);
}
...
action ae_move_IF_CONDITION_5_parser_3(){
  modify_field(fp4_metadata.max_bits_field0, ethernet.dstAddr);
  modify_field(fp4_metadata.max_bits_field1, arp.oper);
}
action ae_move_tiHandleIncomingArpReqest_part_two_parser_3(){
  modify_field(fp4_metadata.max_bits_field0, arp.targetPA);
}
...
action ae_apply_mutations1() {
  modify_field_rng_uniform(fp4_metadata.max_bits_field1, 0,0xffff);
}
...
action ae_move_back_IF_CONDITION_5_parser_3(){
  modify_field(ethernet.dstAddr, fp4_metadata.max_bits_field0);
  modify_field(ethernet_clone.dstAddr, fp4_metadata.max_bits_field0);
  modify_field(arp.oper, fp4_metadata.max_bits_field1);
  modify_field(arp_clone.oper, fp4_metadata.max_bits_field1);
}
action ae_move_back_tiHandleIncomingArpReqest_part_two_parser_3(){
  modify_field(arp.targetPA, fp4_metadata.max_bits_field0);
  modify_field(arp_clone.targetPA, fp4_metadata.max_bits_field0);
}
