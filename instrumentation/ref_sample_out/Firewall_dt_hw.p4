...
field_list fi_bf_hash_fields_16 {
  fp4_visited.ai_calculate_hash_fp4_ti_calculate_hash1;
  fp4_visited.ai_calculate_hash_fp4_ti_calculate_hash2;
  fp4_visited.ai_get_incoming_pos;
  fp4_visited.ai_get_outgoing_pos;
  fp4_visited.ai_noOp_fp4_ipv4_lpm;
  fp4_visited.ai_noOp_fp4_ti_apply_filter;
  fp4_visited.ai_read_bloom_filter1;
  fp4_visited.ai_read_bloom_filter2;
  fp4_visited.ai_write_bloom_filter1;
  fp4_visited.ai_write_bloom_filter2;
  fp4_visited.drop_packet_fp4_ipv4_lpm;
  fp4_visited.drop_packet_fp4_ti_apply_filter;
  fp4_visited.ipv4_forward;
  fp4_visited.set_direction;
  fp4_visited.set_hit;
}
...
action ai_recycle_packet() {
  ...
  modify_field(fp4_visited.ai_calculate_hash_fp4_ti_calculate_hash1, 0);
  modify_field(fp4_visited.ai_calculate_hash_fp4_ti_calculate_hash2, 0);
  modify_field(fp4_visited.ai_get_incoming_pos, 0);
  modify_field(fp4_visited.ai_get_outgoing_pos, 0);
  modify_field(fp4_visited.ai_noOp_fp4_ipv4_lpm, 0);
  modify_field(fp4_visited.ai_noOp_fp4_ti_apply_filter, 0);
  modify_field(fp4_visited.ai_read_bloom_filter1, 0);
  modify_field(fp4_visited.ai_read_bloom_filter2, 0);
  modify_field(fp4_visited.ai_write_bloom_filter1, 0);
  modify_field(fp4_visited.ai_write_bloom_filter2, 0);
  modify_field(fp4_visited.drop_packet_fp4_ipv4_lpm, 0);
  modify_field(fp4_visited.drop_packet_fp4_ti_apply_filter, 0);
  modify_field(fp4_visited.ipv4_forward, 0);
  modify_field(fp4_visited.set_direction, 0);
  modify_field(fp4_visited.set_hit, 0);
}
...
table te_move_fields {
  ...
  actions {
    ai_NoAction;
    ae_move_IF_CONDITION_3_parser_2;
    ae_move_ipv4_lpm_parser_2;
  }
  default_action : ai_NoAction();
}
...
table te_move_back_fields {
  ...
  actions {
    ai_NoAction;
    ai_drop_packet;
    ae_move_back_IF_CONDITION_3_parser_2;
    ae_move_back_fix_IF_CONDITION_3_parser_2;
    ae_move_back_ipv4_lpm_parser_2;
    ae_move_back_fix_ipv4_lpm_parser_2;
  }
  default_action : ai_NoAction();
  size: 2048;
}
...
action ae_move_back_fix_IF_CONDITION_3_parser_2(tcp_syn){
  ...
  modify_field(tcp_clone.syn, tcp_syn);
}
action ae_move_back_fix_ipv4_lpm_parser_2(ipv4_dstAddr){
