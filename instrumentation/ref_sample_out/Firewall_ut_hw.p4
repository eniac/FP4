...
table ti_calculate_hash1 {
    actions {
        ai_calculate_hash_fp4_ti_calculate_hash1;
    }
    default_action:ai_calculate_hash_fp4_ti_calculate_hash1();
    size:1;
}
...
table ti_calculate_hash2 {
    actions {
        ai_calculate_hash_fp4_ti_calculate_hash2;
    }
    default_action:ai_calculate_hash_fp4_ti_calculate_hash2();
    size:1;
}
...
action ai_read_bloom_filter1() {
    ...
    add_to_field(fp4_visited.encoding0, 256);
}
...
table ti_apply_filter {
    ...
    actions {
        drop_packet_fp4_ti_apply_filter;
        ai_noOp_fp4_ti_apply_filter;
    }
    default_action:drop_packet_fp4_ti_apply_filter;
    size:4;
}
...
action drop_packet_fp4_ti_apply_filter() {
    add_to_field(fp4_visited.encoding0, 512);
    modify_field(ig_intr_md_for_tm.ucast_egress_port, 0);
}

action ai_noOp_fp4_ti_apply_filter() {
    add_to_field(fp4_visited.encoding0, 1024);
}
